...
class Slider {
   ...
   animationTape(animation) {
    ...
    options(options) {
      Object.assign(this.settings, this.slider.test(typeof options !== "object", "Do klasy slider zostal przekazany argument niebedacy obiektem, przekazany argument to: " + options, options));
      return this;
    }
